...
export interface VideoLecturesChartProps {
  videoGraph: any[];
  loading: boolean;
  filter: string;
  chartType: ChartType;
...
export const VideoLecturesChart: React.FC<VideoLecturesChartProps> = ({
  videoGraph,
  loading,
  filter,
  chartType,
    ...
    datasets: [
      {
        ...
        borderColor:
          chartType === "doughnut"
            ...
            ? "#f59e0b"
            : "#ffffffff",
        hoverBackgroundColor: chartType === "doughnut" ? undefined : "rgba(217, 119, 6, 1)",
        ...
        callbacks: {
          label: (context: any) =>
            chartType === "doughnut"
              ...
              : ` Videos Watched: ${context.parsed.y}`,
        },
      },
    },
  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-5 flex flex-col h-[390px] transition-all hover:shadow-[0_6px_24px_rgba(245,158,11,0.06)]">
      ...
      <div className="flex-1 w-full min-h-0 relative flex items-center justify-center">
        ...
        {(chartType === "doughnut" ? hasVideoData : videoList.length > 0) ? (
...
export default VideoLecturesChart;
