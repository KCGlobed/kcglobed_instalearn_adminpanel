...
export interface StudentOrdersChartProps {
  orderGraph: any[];
  loading: boolean;
  filter: string;
  chartType: ChartType;
...
export const StudentOrdersChart: React.FC<StudentOrdersChartProps> = ({
  orderGraph,
  loading,
  filter,
  chartType,
    ...
    datasets: [
      {
        ...
        borderColor:
          chartType === "doughnut"
            ...
            ? "#8b5cf6"
            : "#ffffffff",
        hoverBackgroundColor: chartType === "doughnut" ? undefined : "rgba(124, 58, 237, 1)",
        ...
        callbacks: {
          label: (context: any) =>
            chartType === "doughnut"
              ...
              : ` Orders Placed: ${context.parsed.y}`,
        },
      },
    },
  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-5 flex flex-col h-[390px] transition-all hover:shadow-[0_6px_24px_rgba(139,92,246,0.06)]">
      ...
      <div className="flex-1 w-full min-h-0 relative flex items-center justify-center">
        ...
        {(chartType === "doughnut" ? hasOrderData : orderList.length > 0) ? (
...
export default StudentOrdersChart;
