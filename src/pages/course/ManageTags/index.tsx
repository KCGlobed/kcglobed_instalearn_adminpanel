...
const ManageTags: React.FC = () => {
    ...
    const { data, loading, pagination } = useAppSelector((state) => state.tags);
    const pageSize = 5;
    ...
    useEffect(() => {
        dispatch(getTags({
            page: currentPage,
            search: debouncedSearchTerm || debouncedFilters.name, // tag api mapping search to name if needed
            ordering,
                        ...
                        onClick={() => {
                            showModal({
                                ...
                                content: <DeleteConfirmationModal
                                    ...
                                    name={row.name}
                                    onDelete={async () => {
                                        await dispatch(deleteTags(row.id)).unwrap();
                                    }}
                                />,
                                type: 'custom',
                                size: 'md',
