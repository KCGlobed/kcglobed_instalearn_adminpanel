...
import { downloadManagerPdfApi, downloadManagerExcelApi } from '../../../services/apiServices';
import { useModal } from '../../../context/ModalContext';
import useDebounce from '../../../hooks/useDebounce';
import { useAppDispatch } from '../../../hooks/useAppDispatch';
import { useAppSelector } from '../../../hooks/useRedux';
import { getManagers, updateManagerStatus } from '../../../store/slices/managerSlice';
...
import { managerFilterConfig } from '../../../utils/filterConfiguration';
...
const ManageManagers: React.FC = () => {
    ...
    const { data, loading, pagination } = useAppSelector((state: any) => state.managers);
    const pageSize = 10;
            ...
            render: (_, row: any) => {
                ...
                return (
                    <button
                        onClick={async () => {
                            try {
                                await dispatch(updateManagerStatus({ id: row.id, status: !isActive })).unwrap();
                    ...
                    <GlassButton
                        ...
                        onClick={() =>
                            showModal({
                                ...
                                content: <ManagerForm ManagerData={row} />,
                                type: 'custom',
                                size: 'xxl',
                            })
                        }
                ...
                <div className="flex flex-wrap items-center justify-between px-5 py-4 gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <ExportFile
                            ...
                            excelApi={() => downloadManagerExcelApi({
                                search: debouncedSearchTerm,
                                first_name: debouncedFilters.first_name,
                                last_name: debouncedFilters.last_name,
                                email: debouncedFilters.email,
