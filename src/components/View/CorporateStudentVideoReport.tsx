...
import { 
    ...
    downloadCorporateStudentVideoReportPdfApi,
    downloadCorporateStudentVideoReportExcelApi
} from '../../services/apiServices';

const CorporateStudentVideoReport = ({ studentId, courses }: { studentId: number, courses: any[] }) => {
    ...
    const handleDownload = async (type: 'pdf' | 'excel') => {
        ...
        try {
            const apiCall = type === 'pdf' ? downloadCorporateStudentVideoReportPdfApi : downloadCorporateStudentVideoReportExcelApi;
...
export default CorporateStudentVideoReport;
