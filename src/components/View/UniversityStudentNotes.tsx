...
import { 
    fetchUniversityStudentNotesApi,
    downloadUniversityStudentNotesReportPdfApi,
    downloadUniversityStudentNotesReportExcelApi
} from '../../services/apiServices';
import moment from 'moment';

const UniversityStudentNotes = ({ studentId, courses }: { studentId: number, courses: any[] }) => {
    ...
    useEffect(() => {
        const loadNotes = async () => {
            ...
            try {
                setLoading(true);
                setError(null);
                const response = await fetchUniversityStudentNotesApi(studentId, selectedCourseId);
    ...
    const handleDownload = async (type: 'pdf' | 'excel') => {
        ...
        try {
            const apiCall = type === 'pdf' ? downloadUniversityStudentNotesReportPdfApi : downloadUniversityStudentNotesReportExcelApi;
...
export default UniversityStudentNotes;
