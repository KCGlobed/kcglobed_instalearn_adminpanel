...
import { changeCorporateAdminPasswordApi } from '../../services/apiServices';

interface CorporateAdminPasswordFormProps {
...
const CorporateAdminPasswordForm: React.FC<CorporateAdminPasswordFormProps> = ({
    adminId,
}) => {
    ...
    const onSubmit = async (data: PasswordFormValues) => {
        try {
            ...
            const res = await changeCorporateAdminPasswordApi(payload);
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-indigo-50 border border-indigo-100">
                ...
                <div>
                    <h3 className="text-sm font-bold text-indigo-900">
                        Change Corporate Admin Password
                    </h3>

                    <p className="text-xs text-indigo-500 mt-1 leading-relaxed">
                        Create a secure password for the corporate admin account.
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full h-12 pl-12 pr-12 rounded-2xl border bg-white text-sm font-medium transition-all outline-none
                        ${errors.password
...
export default CorporateAdminPasswordForm;
